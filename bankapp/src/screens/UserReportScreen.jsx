...
const UserReportScreen = () => {
  ...
  return (
    <ScrollView contentContainerStyle={[styles.container, { backgroundColor: selectedTheme.background }]}>
      <Text style={[styles.title, { color: selectedTheme.text }]}>User Report</Text>

      <Text style={[styles.label, { color: selectedTheme.text }]}>Select User</Text>
      <View style={[styles.pickerContainer, { borderColor: selectedTheme.card }]}>
        <Picker
